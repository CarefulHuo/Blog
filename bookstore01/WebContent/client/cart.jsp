...
<%@taglib uri="http://www.yyf.tag" prefix="p"%>
			...
			<tr>
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td><img
								src="${pageContext.request.contextPath}/client/ad/page_ad.jpg"
								width="900" height="89" />
								<table width="100%" border="0" cellspacing="0">
									<tr>
										<td><img
											src="${pageContext.request.contextPath}/client/images/buy1.gif"
											width="635" height="38" /></td>
									</tr>
									<tr>
										<td>
											<table cellspacing="1" class="carttable">
											...
											</table> <c:set var="total" value="0" /> <c:forEach items="${cart}"
												...
												<table width="100%" border="0" cellspacing="0">
													<tr>
														...
														<td width="10%"><a
															href="${pageContext.request.contextPath}/client/cart/changeCart.do?id=${entry.key.id}&count=0"
											...
											<div style="text-align: right; margin-top: 10px">
												<a
													href="${pageContext.request.contextPath}/client/products/findProductByCategory.do?category=">
