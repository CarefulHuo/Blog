...
<body class="main" >
	...
	<div id="divcontent">
		<table width="900px" border="0" cellspacing="0">
			<tr>
				<td width="497">
					<%-- <a href="${pageContext.request.contextPath}/client/notice/findAllNotices.do"></a> --%>
					<img src="${pageContext.request.contextPath}/client/images/billboard.gif" width="497" height="38"  />
					
					<table cellspacing="0" class="ctl">
						<tr>
							<td width="485" height="29">${notices[0].details }</td>
						</tr>
					</table>
				</td>
					...
					<table width="100%" border="0" cellspacing="0">
						...
						<c:forEach items="${products }" var="p">
							<td style="width:80; text-align:center">
								...
								<br /> 
								<a href="${pageContext.request.contextPath}/client/products/findProductById.do?id=${p.id}">${p.name}</a>
								<%-- <br />作者:${pArray[2] } --%>
							</td>
						</c:forEach>
						</tr>
