...
<div class="dtree">
	...
	<script type="text/javascript">
	 ...
	 --%>
 <tr>
  	<td><a href="${pageContext.request.contextPath}/admin/products/listProduct.do" target="mainFrame" class="left_list">商品管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/admin/products/download.jsp" target="mainFrame" class="left_list">销售榜单</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/admin/orders/findAllOrders.do" target="mainFrame" class="left_list">订单管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/admin/notice/findAllNotices.do" target="mainFrame" class="left_list">公告管理</a></td>
  </tr>
</table>
</body>
</html>
