...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/admin/products/findProductByManyCondition.do"
		method="post">
							...
							<c:forEach items="${products}" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/products/findProductById.do?id=${p.id}">
											<img
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/products/deleteProduct.do?id=${p.id}">
											<img
