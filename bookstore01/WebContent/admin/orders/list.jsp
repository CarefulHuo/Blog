...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/admin/orders/findOrdersByCondition.do"
		method="post">
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="id" size="15" value="${id }" id="Form1_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									收件人：</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="receiverName" size="15" value="${receiverName }" id="Form1_userName"
									class="bg" />
								</td>
							</tr>
							<tr>
							...
							<c:forEach items="${orders}" var="order">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/admin/orders/findOrderById.do?id=${order.id}&type=admin">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><c:if
											...
											<a
												href="${pageContext.request.contextPath}/admin/orders/removeOrderById.do?id=${order.id}">
												<img
