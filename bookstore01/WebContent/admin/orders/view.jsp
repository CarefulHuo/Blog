...
<body>
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">${items[0].order.user.username }</td>
		</tr>
				 ...
				 <c:forEach items="${items}" var="item" varStatus="vs">
						<tr
							...
							<td width="8%" align="center"><img
								src="${pageContext.request.contextPath}${items[0].product.imgurl}"
								width="50" height="50"></td>

							<td align="center" width="18%">${items[0].product.id }</td>
							<td align="center" width="10%">${items[0].product.name }</td>
							<td align="center" width="10%">${items[0].product.price }</td>
							<td width="7%" align="center">${items[0].buynum }</td>
							<td width="7%" align="center">${items[0].product.category }</td>
							<td width="31%" align="center">${items[0].product.description}</td>
						</tr>
					</c:forEach> 
