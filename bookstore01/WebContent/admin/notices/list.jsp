...
<%@taglib uri="http://yyf.pager-tags" prefix="p"%>
<HTML>
<HEAD>
...
<body>
	...
	<form id="Form1" name="Form1" action="" method="post">
		<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
			<tbody>
			<tr><font color="red" size="3">${add_notice_error }</font></tr>
				<tr>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${notices}" var="n">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%">
										<a href="${pageContext.request.contextPath}/admin/notice/findNoticeById.do?nid=${n.n_id}">
											<img src="${pageContext.request.contextPath}/admin/images/i_edit.gif" border="0" style="CURSOR: hand"> 
										</a>
									</td>
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/admin/notice/removeNotice.do?id=${n.n_id}">
											<img
							...
							submitUrl="${pageContext.request.contextPath}/admin/notice/findAllNotices.do?pageIndex={0}"/>
							</tr>
						</table>
					</td>
				</tr>
